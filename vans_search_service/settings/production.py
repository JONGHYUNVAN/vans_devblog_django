...
CSRF_TRUSTED_ORIGINS = [
    f"https://{host}" for host in get_env_variable('ALLOWED_HOSTS', 'localhost').split(',')
]
...
CORS_ALLOWED_ORIGINS = [
    f"https://{host}" for host in get_env_variable('FRONTEND_HOSTS', 'localhost').split(',')
]
...
DEFAULT_FROM_EMAIL = get_env_variable('DEFAULT_FROM_EMAIL', 'noreply@vansdevblog.online')
