...
from search.models import PopularSearch, SearchLog
...
class TestSearchLog:
    ...
    def test_create_search_log(self):
        ...
        log = SearchLog.objects.create(
            query="Django REST", results_count=5, response_time_ms=120
        )
    ...
    def test_record_log_class_method(self):
        ...
        log = SearchLog.record_log(
            query="Python Testing", results_count=3, response_time_ms=200
        )
    ...
    def test_search_log_str_representation(self):
        ...
        log = SearchLog.objects.create(query="Test Query", results_count=10)
...
class TestPopularSearch:
    ...
    def test_create_popular_search(self):
        """인기 검색어 생성 테스트"""
        popular = PopularSearch.objects.create(query="React Hooks", search_count=15)
    ...
    def test_popular_search_str_representation(self):
        ...
        popular = PopularSearch.objects.create(query="Test Framework", search_count=25)
